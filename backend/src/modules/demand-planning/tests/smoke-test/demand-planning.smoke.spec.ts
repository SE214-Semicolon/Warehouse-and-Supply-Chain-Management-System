...
const TEST_SUITE_ID = `demand-smoke-${Date.now()}-${Math.random().toString(36).substring(7)}`;

describe('Demand Planning Module - Smoke Tests', () => {
  ...
  describe('SMOKE-DEMAND-01: Critical Path', () => {
